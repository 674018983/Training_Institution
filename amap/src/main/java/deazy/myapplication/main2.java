...
public class main2 extends Activity implements LocationSource ,AMapLocationListener,GeocodeSearch.OnGeocodeSearchListener {
...
//                        .getLatLonPoint()));
                ...
                ToastUtil.show(main2.this, R.string.no_result);
            }
        } else {
